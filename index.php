...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/logo_fondos.jpg" />
    <!-- <link href="assets/fabrica/img/logo_fondos.jpg" type="image/x-icon"> -->
    <!-- Bootstrap icons-->
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Realice su compra</h1>
